...
console.log(arr2.includes("Shyam"));  // true
console.log(arr2.includes("Shy"));  // false
console.log(arr2.includes("shyam"));  // false

console.log(str.includes('u'));  // true
console.log(str1.includes('ushwah'));  // false


// indexOf (string and array)
let arr3= ["Ram", "Shyam", "Versha", "Raman"];
console.log(arr3.indexOf("Versha"));
